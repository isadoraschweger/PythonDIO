...
transacoes_dia = 0  # Contador de transações diárias
...
while True:
    ...
    if transacoes_dia >= LIMITE_TRANSACOES:
        print("Operação falhou! Você excedeu o número de transações diárias permitidas.")
        continue
    ...
    if opcao == "1":
        ...
        if valor > 0:
            ...
            transacoes_dia += 1  # Incrementa o número de transações diárias
        else:
